...
Begin VB.Form frmDeliver 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox Combo2 
         ForeColor       =   &H00404040&
         Height          =   315
         ItemData        =   "frmDeliver.frx":000C
         Left            =   1320
         List            =   "frmDeliver.frx":000E
      ...
      Begin VB.ComboBox Combo4 
         ...
         ForeColor       =   &H00404040&
         Height          =   315
         ItemData        =   "frmDeliver.frx":0010
         Left            =   1320
         List            =   "frmDeliver.frx":0012
         TabIndex        =   8
         Top             =   240
         Width           =   2535
      End
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.ComboBox comSearch 
         ...
         ForeColor       =   &H00404040&
         Height          =   315
         ItemData        =   "frmDeliver.frx":01B1
         Left            =   840
         List            =   "frmDeliver.frx":01B3
         Style           =   2  'Dropdown List
         TabIndex        =   39
         Top             =   240
         Width           =   1575
   ...
   Begin MSDBGrid.DBGrid DBGrid1 
      Bindings        =   "frmDeliver.frx":1364
      Height          =   2130
      Left            =   120
      OleObjectBlob   =   "frmDeliver.frx":1378
      TabIndex        =   9
      Top             =   4680
      Width           =   6735
   End
...
cmd7.Enabled = False
a = Text1.Text
  Data5.RecordSource = ("Select * from DeliverDetails where DeliveryNo = '" & a & "'")
Data5.Refresh
Exit Sub
AddErr:
...
MsgBox "Enter number of quantity to delivered, please try again.", vbExclamation, "Attention"
Exit Sub
End If
b = Val(b)
...
If Combo2.Text = "" Then
MsgBox "Please enter the supplier who deliver.", vbExclamation, "Attention"
Combo2.SetFocus
Exit Sub
End If
MsgBox "Delivered product successfully updated.", vbInformation, "Update"
